 ...
 * Authentik includes `groups` in the userinfo response when the `groups` scope/claim
 * mapping is attached to the OAuth2 provider (configured by the OIDC setup Lambda).
 */
