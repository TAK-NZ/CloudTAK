...
- [`README-OIDC-FORCED.md`](README-OIDC-FORCED.md) — forced OIDC login
- [`FORK-DELTA.md`](FORK-DELTA.md) — "In-app OIDC login" covers the login route
  (`api/stateless/routes/login.ts`) and `Login.vue`
