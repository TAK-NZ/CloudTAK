...
- `api/stateless/routes/icons.ts` - Lines ~609 and ~641
...
Standalone fix for icon rendering. See [`FORK-DELTA.md`](FORK-DELTA.md) →
"Icons, sprites and styling" for the neighbouring changes in
`api/stateless/routes/icons.ts`.
